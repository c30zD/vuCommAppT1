...
/**
 * Binds data to be displayed on {@link vuit.teamwork.ui.ContactsActivity}
 *
 * @author c30zD
 */
public class ContactListBinder extends BaseAdapter {
    ...
    */
    ...
    public ContactListBinder(Activity activity) {       // TODO 2nd argument: data to inflate from
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View vi = convertView;
        if (convertView == null) {
            vi = inflater.inflate(R.layout.contact_list_row_layout, null);
            holder = new ViewHolder();
            holder.photo = (ImageView) vi.findViewById(R.id.imgContactPhoto);
            holder.lblContactName = (TextView) vi.findViewById(R.id.contactName);
            holder.lblDescription = (TextView) vi.findViewById(R.id.contactJob);
            holder.lblCommonProjects = (TextView) vi.findViewById(R.id.lblCommonProjects);
            vi.setTag(holder);
        } else {
        ...
        holder.lblContactName.setText("John Doe");
        ...
        */
        ...
        String strCommonProjects = String.format(vi.getContext()
                .getApplicationContext().getResources()
                .getString(R.string.number_of_common_projects), numberOfProjects);

        holder.lblCommonProjects.setText(strCommonProjects);

        holder.lblDescription.setText("Sales Dept.");
